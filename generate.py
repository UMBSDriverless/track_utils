...
parser.add_argument("--trackwidth", type=float, help="Track width factor (default: 0.7).", default=1.4)
...
def domains_checker():
    ...
    if args.trackwidth < 0.1 or args.trackwidth > 2.0:
        error_printer("trackwidth must be between 0.1 and 2.0")
